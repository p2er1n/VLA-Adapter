...
TASK_MAX_STEPS = {
    ...
    TaskSuite.PICK_AND_PLACE_1_50: 200,
    TaskSuite.REALWORLD: 200,
}
...
class Server:
    def __init__(self, cfg, model, action_head, proprio_projector, noisy_action_projector, processor, resize_size):
        self.model = model
        ...
        try:
            ...
            def run_episode_modified(
                ...
                def prepare_observation_modified(obs, resize_size):
                    ...
                    return observation
                observation = prepare_observation_modified(obs, resize_size)
                # if len(action_queue) == 0:
                    # Query model to get action
                actions = get_action(
                    cfg,
...
@draccus.wrap()
def start_server(cfg: GenerateConfig) -> None:
